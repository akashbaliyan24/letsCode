                    ...
                    <div className="card-body">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="avatar placeholder">
                                <div className="bg-netural text-neutral-content rounded-full w-24 h-24 ring ring-primary ring-offset-base-100 ring-offset-2">
                                    {authUser.image ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="stat bg-base-200 rounded-box">
                                ...
                                <div className="stat-value tetx-lg">
                                    {authUser.image ? "Upload" : "Not Set"}
                                </div>
                                <div className="stat-desc">
                        ...
                        <div className="card-actions justify-end mt-6 ">
                            ...
                            <button className="btn btn-primary btn-outline">Change Password</button>
                        </div>
                    </div>
                </div>
                <ProfileSubmission/>
