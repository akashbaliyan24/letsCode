                ...
                <div className="bg-base-100 rounded-lg shadow-xl w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit(handleFormSubmit)} className="p-6 space-y-4">
                        <div className="form-control">
                            ...
                            <input type="text" className="input input-bordered w-full" placeholder='Enter playlist name' {...register('name', { required: 'Playlist name is required' })} />
                            {errors.name && (
                                <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <textarea className="textarea textarea-bordered h-24" placeholder='Enter playlist description' {...register('description')} />
                        </div>
